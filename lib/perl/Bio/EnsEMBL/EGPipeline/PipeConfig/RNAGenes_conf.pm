...
sub default_options {
  ...
  return {
    ...
    pipeline_name => $self->tagged_pipeline_name('rna_genes', $self->o('ensembl_release')),
    ...
    id_db_dbname => $self->private_conf('ENSEMBL_ENA_IDENTIFIERS_DBNAME'),
    id_db_host   => $self->private_conf('ENSEMBL_ENA_IDENTIFIERS_HOST'),
    id_db_port   => $self->private_conf('ENSEMBL_ENA_IDENTIFIERS_PORT'),
    id_db_user   => $self->private_conf('ENSEMBL_ENA_IDENTIFIERS_USER'),
    id_db_pass   => undef, # always specify manually
    id_db => {
