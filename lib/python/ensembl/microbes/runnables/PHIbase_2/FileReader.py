        ...
        with open(self.param('inputfile'), newline='') as csvfile:
            ...
            for row in reader:
                entry_line_dict = {
                    ...
                    "patho_interactor_type": cm.patho_interactor_type,
                    "patho_curie_type": cm.patho_curie_type,
                    ...
                    "host_interactor_type": cm.host_interactor_type,
                    "host_curie_type": cm.host_curie_type,
